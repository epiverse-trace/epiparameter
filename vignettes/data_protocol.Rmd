...
knitr::kable(
  data.frame("Epidemiological_Distribution" = epidist), 
  align = "cc"
)
```
...
- ("Middle East Respiratory Syndrome" OR MERS) AND "onset to death" AND (estimate OR inference)
- (ebola OR EVD) AND "onset to death" AND (estimate OR inference)
