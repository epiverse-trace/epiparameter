...
In epidemics, understanding the delay between becoming exposed to an infectious disease and the onset of symptoms (i.e. incubation period) is informative for defining a possible quarantine period. Quarantine for exposed individuals are one of the most widely used nonpharmaceutical interventions (NPIs) to suppress the transmission and bring the basic reproduction number ($R_0$) down. As pointed out by @nishiura_determination_2009 using a right-skewed probability distribution there is a non-zero probability of having extremely large quarantine periods (e.g. 100 days).
...
```{r, get delay dist with study, eval = FALSE}
...
```{r, plot epidist, fig.align = "center", fig.height = 8, fig.width = 8, out.width = "500px", eval = FALSE}
plot(sars_cov_incub)
```
...
```{r, compare sars and mers, fig.align = "center", fig.height = 8, fig.width = 8, out.width = "500px", eval = FALSE}
...
```{r, epiestim with epiparameter, fig.align = "center", fig.height = 8, fig.width = 8, out.width = "500px", fig.cap="The epidemic curve for the incidence of H1N1 flu cases, below this is the estimated $R_t$ value and the bottom facet is the serial interval distribution used in the calculation of $R_t$.", eval = FALSE}
...
```{r, epinow2 with epiparameter setup, eval=FALSE}
...
```{r R0 with epiparameter, eval = FALSE}
...
```{r, estimate Rt with R0 for ebola, eval = FALSE}
out <- estimate.R(
...
```{r plot R0 ebola, fig.align = "center", fig.height = 8, fig.width = 8, out.width = "500px", fig.cap="Estimated value of $R_t$ for the incidence data of ebola for Sierra Leone 2014.", eval=FALSE}
...
```{r plotting range epidist, fig.align = "center", fig.height = 8, fig.width = 8, out.width = "500px", eval=FALSE}
