...
have the function name `convert_dist_*()` (where `*` and `dist` are placeholders). These convert
either one set of statistical distribution parameters to common summary statistics (e.g. `convert_lnorm_params()`)
