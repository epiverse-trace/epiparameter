...
if (requireNamespace("visNetwork", quietly = TRUE)) {
  visNetwork::visNetwork(nodes, edges) |>
    ...
    visNetwork::visGroups(groupname = "<epiparameter>", color = colours[1]) |>
    visNetwork::visGroups(groupname = "Getters", color = colours[2]) |>
    visNetwork::visGroups(groupname = "Modifiers", color = colours[3]) |>
    visNetwork::visGroups(
      groupname = "Distribution functions", 
      color = colours[4]
    ) |>
    visNetwork::visGroups(groupname = "Utilities", color = colours[5]) |>
    visNetwork::visGroups(groupname = "Checkers", color = colours[6]) |>
    visNetwork::visGroups(groupname = "Conversions", color = colours[7]) |>
    visNetwork::visGroups(groupname = "Coercion", color = colours[8])
} else {
  message(
    "The {visNetwork} R package is not installed so the architecture diagram ",
    "cannot be rendered"
  )
}
```
