...
More details on where the parameters come from can be found in the
[Epidemiological parameter data sources
vignette](https://epiverse-trace.github.io/epiparameter/articles/data_sources.html).
...
The library bundled with the package is a development and
experimentation set rather than a comprehensive repository. Parameters
curated for long-term use live in
[grEPI](https://who-collaboratory.github.io/collaboratory-grepi-web/)
and [`{epireview}`](https://mrc-ide.github.io/epireview/), and both can
be read into `<epiparameter>` objects. See the [Epidemiological
parameter data
sources](https://epiverse-trace.github.io/epiparameter/articles/data_sources.html)
vignette for each source and how to read it, and [Using {epireview} with
{epiparameter}](https://epiverse-trace.github.io/epiparameter/articles/data_from_epireview.html)
for a worked example of converting {epireview} parameter tables with
