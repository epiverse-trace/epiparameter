...
# _{{ packagename }}_ <img src="man/figures/logo.png" align="right" width="120" />
...
_{{ packagename }}_ is an `R` package that contains a library of epidemiological parameters for infectious diseases and a set classes and helper functions to be able to work with the data. It also includes functions to extract and convert parameters from reported summary statistics.
...
The easiest way to install the development version of _{{ packagename }}_ is to use the `{pak}` package:
...
The parameters of a distribution can be converted to and from mean and standard deviation. In _{{ packagename }}_ we implement this for a variety of distributions:
...
Contributions to _{{ packagename }}_ are welcomed. Please follow the [package contributing guide](https://github.com/epiverse-trace/epiparameter/blob/main/.github/CONTRIBUTING.md).
