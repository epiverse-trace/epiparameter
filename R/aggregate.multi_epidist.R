#' Convert a multi_epidist object to a single epidist
#'
...
#'
#' @returns
#' An epidist object with synthetized central estimate value and uncertainty
#'
#' @examples
#' epidist_db(epi_dist = "serial interval", disease = "ebola")
#'
#' @export
aggregate.multi_epidist <- function(
    x,
  ...
  # Control that the multi_epidist object contains only the same type of
